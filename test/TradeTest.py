...
class TradeTest(unittest.TestCase):
    ...
    def test_get_order_info(self):
        print(self.tradeApi.get_order(instId="ETH-USDT",clOrdId="testbtcusdt01"))
    ...
    def test_get_fills_history(self):
        print(self.tradeApi.get_fills_history("SWAP"))
    ...
    # 历史订单记录
    def test_get_order_histry_archive(self):
        # print(self.tradeApi.get_orders_history_archive(instType="SWAP",begin='1684857629313',end='1684857629313'))
        print(self.tradeApi.get_orders_history_archive(instType="SWAP"))
    def test_place_order(self):
        # 西单btc
        print(self.tradeApi.place_order("BTC-USDT-SWAP", tdMode="isolated", clOrdId="testbtcusdt01", side="buy", ordType="market",
                                        sz="0.6",posSide="long"))
        # print(self.tradeApi.place_order("ETC-USDT-SWAP", tdMode="isolated", clOrdId="testbtcusdt01", side="sell",
        #                                 ordType="market",
        #                                 sz="0.1", posSide="long"))
    # def test_batch_order(self):
    #     orderData = [{
